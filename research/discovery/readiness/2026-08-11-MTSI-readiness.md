# MTSI Discovery Readiness — 2026-08-11

```yaml
symbol: MTSI
candidate_name: MACOM Technology Solutions
review_date: 2026-08-11
policy_version: v1.3
material_to_current_allocation: true
affected_lanes: [semiconductor_interconnect_and_memory]
research_stage: R1_researchable
readiness_status: researchable_open
blocker_type: evidence_based
blocker_reason: "Net debt, convertible claims, equity awards, customer concentration and the current diluted enterprise-value denominator remain unbounded."
classification: incubate
dashboard_surface_status: not_required_pre_promotion
next_evidence_source: "Build a same-lane R2 comparison with LASR, COHR, CRDO, LITE and AAOI by 2026-08-14."
next_evidence_due: 2026-08-14
...
source_ids: [mtsi_q3_fy2026_10q, completed_close_universe_2026_08_10]
...
```yaml
what_could_become_scarce: RF, optical and photonic semiconductors are direct inputs to data-center and defense connectivity.
who_controls_or_removes_scarcity: MACOM Technology Solutions controls or supplies the relevant assets, products or technical capability.
...
public_security_expression: MTSI is a listed common stock eligible for research, but R1 creates no buy eligibility.
...
Fiscal Q3 revenue was USD 342.2 million, data-center revenue was USD 137.6 million and diluted weighted-average shares were 78.4 million. Net debt, convertible claims, equity awards, customer concentration and the current diluted enterprise-value denominator remain unbounded.
...
filings_and_reports: Current primary filing reviewed and indexed under mtsi_q3_fy2026_10q.
...
next_action: Build a same-lane R2 comparison with LASR, COHR, CRDO, LITE and AAOI by 2026-08-14.
```
...
Source: [primary filing](https://www.sec.gov/Archives/edgar/data/1493594/000149359426000038/mtsi-20260703.htm), published no later than 2026-08-10 and retrieved 2026-08-11.
