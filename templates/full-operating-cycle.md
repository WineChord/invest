...
6. Run freshness monitoring: check SEC filings, company IR, earnings material, financing, dilution, debt, contracts, regulatory changes, management changes, and price dislocations for holdings, active watchlist symbols, and decision-relevant candidates. Pair the event filing index with the default foundational-first filing index over the same applicable listed-security scope and reconcile their selected accessions; an event selector must not hide a newer annual or business filing.
