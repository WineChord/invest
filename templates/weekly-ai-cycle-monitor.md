...
Account-permitted actions under policy `v1.0` are buy eligible common stock, add, hold, trim, exit, wait, or hold cash. Puts, shorts, leverage, margin, crypto tokens, private shares, and non-US-listed instruments are outside policy unless a later approved policy changes this.
