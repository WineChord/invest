...
Account-permitted actions under policy `v1.1` are buy eligible common stock, add, hold, trim, exit, wait, hold cash, or park idle liquidity in an approved short-duration U.S. Treasury reserve such as SGOV. Puts, shorts, leverage, margin, crypto tokens, private shares, and non-US-listed instruments are outside policy unless a later approved policy changes this.
